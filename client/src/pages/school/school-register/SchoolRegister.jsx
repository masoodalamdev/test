...
function SchoolRegister() {
  ...
  const { name, principalName, email, password, password_confirmation, contact, tc } = state;
  ...
  const registerUser = async (data) => {
    const response = await axios.post("http://localhost:8000/api/school/register", data);
  ...
  return (
    ...
    // sx={{ display: 'flex', flexWrap: 'wrap' }}
     ...
     >
          ...
          <TextField id="standard-basic" label="Principal Name" variant="standard" name="principalName" onChange={handleInputChange} value={principalName}/>
          <br />
